	...
	return (
		<header>
			<div className="home" onClick={handleClick}>
				<svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 424.098 424.098" width="30">
					<path fill="#565758" d="M351.191,401.923H72.901c-4.487,0-8.129-3.633-8.129-8.129V242.262l-56.664-0.114
